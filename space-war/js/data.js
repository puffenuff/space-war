...
const PLANETS = {
  ...
  8: {
    ...
    partSpots: { engine: [135, 0, 75] }, outfitColor: 0x4a7ab8, caveRadius: 100,
  },
  9: {
    name: 'Xenar Prime', theme: 'alien',
    ground: 0x5b3a7a, ground2: 0x3c2456, sky: 0x2a1a44, fog: 0x4a2f6e,
    size: 640, hills: 17, craters: 7,
    enemyCount: 20, dugSites: 6, wreckPos: [105, 0, 105], vehicleType: 'alien',
    partSpots: { noseCone: [-135, 0, -60] }, outfitColor: 0xd4af37, caveRadius: 120,
